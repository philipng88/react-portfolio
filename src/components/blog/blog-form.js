...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: '',
      featured_image: '',
      apiUrl: 'https://philipng.devcamp.space/portfolio/portfolio_blogs',
      apiAction: 'post'
    }
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://philipng.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`, 
        apiAction: 'patch'  
      })
    }
  }
  ...
  render() {
    return (
      <form onSubmit={this.handleSubmit} className='blog-form-wrapper'>
        ...
        <button className='btn' id='modal-btn'>Save</button>
      </form>
    )
  }
}